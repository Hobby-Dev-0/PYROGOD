...
import pyrogod.database.afkdb as pyrogod
from pyrogod.helpers.pyrohelper import user_afk
from pyrogod.modules.alive import get_readable_time
from pyrogod.helpers.utils import get_message_type, Types
...
async def afk(client, message):
    ...
    if not arg:
        ...
        reason = arg
    await pyrogod.set_afk(True, afk_time, reason)
...
async def afk_mentioned(_, message):
    global MENTIONED
    afk_time, reason = await pyrogod.afk_stuff()
